  ...
  return (
    <div>
     ...
     <div className=" absolute left-10  ">
      ...
      <div className="absolute bottom-60   right-40 mx-10 my-28 bg-transparent hover:bg-gray-500 text-white  text-[32px] font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded w-394 h-82   "><button>View All Products</button></div>
     </div>
   </div>
  )
}
