      ...
      <div className="relative bg-[#E6E1E1]  py-10    my-80  top-80    ">
        <div className=' py-4 my-4 top-20'>
         ...
         <div className='relative ml-9 mt-1 right-80   bottom-80 pl-80 pt-1 	  '>
          ...
          <button className='bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-4 px-8 border border-red-500 hover:border-transparent rounded mx-64 my-10 top-50'>shop Now</button>
         </div>
    </div>
    </div>
  )
