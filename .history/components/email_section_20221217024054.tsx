  ...
  return (
    <div className=' absolute mt-80 pt-80 '>
       ...
       <h1 className=' absolute ml-30 mt-10 pl-40 pt-18 bottom-40 text-[53px] font-verdana '>
        ...
        <div>
          <button className='absolute ml-80 left-80  pl-8  bottom-14 text-[40px] font-verdana text-left  h-18	bg-black hover:bg-gray-700 text-white font-bold py-2 px-4 rounded '>Subscribe</button>
        </div>
    </div>
  )
}
