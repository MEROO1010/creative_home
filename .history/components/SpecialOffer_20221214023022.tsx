      ...
      <div className="relative bg-[#E6E1E1]  py-10    my-80  top-80    ">
        <div className=' py-4 my-4 top-20'>
         ...
         <div className='static mt-40 pl-8	'>
          ...
          <button className=' relative bg-transparent hover:bg-red-500 text-[200] text-red-700 font-semibold hover:text-white py-4 px-8 border border-red-500 hover:border-transparent rounded mx-60 my-50 bottom-40 w-80 h-20'>shop Now</button>
         </div>
    </div>
    </div>
  )
