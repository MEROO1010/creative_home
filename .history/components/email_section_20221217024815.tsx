  ...
  return (
    <div className=' absolute mt-80 pt-80 '>
       ...
       <h1 className=' absolute ml-30 mt-10 pl-40 pt-18 bottom-40 text-[53px] font-verdana '>
        ...
        <div>
          <button className='absolute ml-80 left-80  bottom-16 text-[30px] font-verdana h-20 w-80 h-18	bg-black hover:bg-gray-700 text-white font-bold  rounded '>Subscribe</button>
        </div>
    </div>
  )
}
